    ...
    return (
        ...
        >
            <Prose>
                ...
                <p>In order to check the certificate signature, the Jutge public key has to be downloaded and installed:</p>
                <p>
                    <Button asChild>
                        <a href="https://jutge.org/documentation/certificates/publickey">
