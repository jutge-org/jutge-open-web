...
export function AdministratorIndex() {
    return (
        <nav aria-label="Administrator sections" className="grid gap-4 sm:grid-cols-2">
            {administratorIndexItems.map((item) => {
                const Icon = indexIcons[item.label] ?? LayoutDashboard
