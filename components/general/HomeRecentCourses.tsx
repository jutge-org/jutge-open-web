...
import { CourseTitleSummaryTooltip } from '@/components/courses/CourseTitleSummaryTooltip'
...
function RecentCourseRow({ course }: { course: RecentCourseItem }) {
    return (
        <CourseTitleSummaryTooltip
            title={recentCourseTitle(course)}
            iconUrl={course.iconUrl}
            ownerName={course.ownerName}
            description={course.description}
            accessedAt={course.accessedAt}
        >
            <Link
