/*
    ...
    This is a copy of https://github.com/Qovery/react-xtermjs/blob/develop/src/xterm.tsx
    with just a single modification: add the `use client` directive.

Otherwise, NextJS was complaining about document not being defined.

Maybe better solutions exist, but this is the one I could find with my limitted
knowledge os NextJS.
