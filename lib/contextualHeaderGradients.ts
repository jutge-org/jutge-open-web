...
export const DEFAULT_CONTEXTUAL_HEADER_GRADIENTS: ContextualHeaderGradientsPreference = CONTEXTUAL_HEADER_GRADIENTS_ON

export function parseContextualHeaderGradients(value: string | null): ContextualHeaderGradientsPreference | null {
...
export function isContextualHeaderGradientsEnabled(preference: ContextualHeaderGradientsPreference): boolean {
