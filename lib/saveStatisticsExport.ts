...
export async function saveStatisticsCsv(records: Record<string, unknown>[], suggestedName: string): Promise<void> {
...
export async function saveStatisticsSvg(svg: SVGSVGElement | null | undefined, suggestedName: string): Promise<void> {
    if (!svg) return
